...
static const struct dma_buf_ops gem_dmabuf_ops =  {
	...
	.map = nx_drm_gem_dmabuf_kmap, //.kmap = nx_drm_gem_dmabuf_kmap,
	.map_atomic = nx_drm_gem_dmabuf_kmap_atomic,//.kmap_atomic = nx_drm_gem_dmabuf_kmap_atomic,
	.unmap = nx_drm_gem_dmabuf_kunmap,//.kunmap = nx_drm_gem_dmabuf_kunmap,
	.unmap_atomic = nx_drm_gem_dmabuf_kunmap_atomic,//.kunmap_atomic = nx_drm_gem_dmabuf_kunmap_atomic,
